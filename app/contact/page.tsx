  ...
  return (
    <div style={{ backgroundColor: '#f9f9f9', minHeight: '100vh', paddingBottom: '50px' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px 20px 0' }}>
        <Link href="/" style={{ color: '#1976d2', textDecoration: 'none', fontWeight: 'bold' }}>
          ← Back to Home
        </Link>
      </div>
      ...
      <div style={{ maxWidth: '800px', margin: '30px auto', padding: '0 20px', fontFamily: 'Arial, sans-serif' }}>
        ...
        {/* Ads Section (Form کے نیچے) */}
        <div style={{ marginTop: '40px', backgroundColor: '#fff', padding: '20px', borderRadius: '15px', textAlign: 'center', border: '1px solid #eee' }}>
          <p style={{ fontSize: '0.7rem', color: '#bbb', marginBottom: '10px' }}>ADVERTISEMENT</p>
          <div style={{ minHeight: '150px', backgroundColor: '#fafafa', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ddd' }}>
            Responsive Ad Unit
          </div>
        </div>
      </div>
...
// Styles
const labelStyle = { display: 'block', marginBottom: '5px', fontWeight: 'bold' } as React.CSSProperties;
